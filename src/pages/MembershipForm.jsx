...
function MembershipForm() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 pb-20 pt-20 md:pt-30">
      <motion.h1
        {...fadeUp()}
      ...
      >
        ...
        <div className="pt-4">
          <button
            id="btnSubmit"
            type="submit"
            className="w-full text-white rounded-full bg-gradient-to-r from-cyan-400 to-fuchsia-500 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-black shadow-[0_0_24px_rgba(56,189,248,0.8)] hover:brightness-110 transition"
          >
            Registrati
          </button>
        </div>
