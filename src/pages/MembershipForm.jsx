        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-4 md:grid md:grid-cols-[1.1fr_minmax(0,1.1fr)] md:items-start">
          ...
          >
            ...
            <p className="text-xs text-slate-300 md:text-sm max-w-md md:max-w-none mx-auto md:mx-0">
              ...
              inviata almeno 24 ore prima dell&apos;ingresso in struttura.
            </p>

            <div className="hidden md:flex flex-col gap-2 text-[0.75rem] text-slate-300">
          ...
          <motion.form
            ...
            className="mt-2 space-y-5 rounded-2xl border border-white/10 bg-black/60 p-6 text-sm backdrop-blur md:mt-0"
          >
