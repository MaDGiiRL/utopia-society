...
export default function NewEventPanel() {
  ...
  return (
    <div className="space-y-6 md:space-y-7 max-w-5xl mx-auto w-full px-3 sm:px-0">
      {/* Header */}
      ...
      <div className="space-y-3 rounded-2xl border border-white/10 bg-slate-950/75 p-4">
        <div className="flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className={`inline-flex h-9 items-center gap-1 rounded-full border border-slate-600/70 px-3 text-[10px] uppercase tracking-[0.16em] text-slate-200 hover:border-cyan-400/70 hover:text-cyan-100 transition ${
        ...
        <div className="-mx-2 max-h-[420px] overflow-x-auto overflow-y-auto rounded-xl border border-slate-800/80 bg-slate-950/70 px-2 py-1 sm:mx-0">
          {eventsLoading ? (
            ...
            <div className="min-w-[720px] sm:min-w-0">
              <ul className="divide-y divide-slate-800 text-[11px] min-w-full">
                {events.map((ev) => {
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 pt-1 sm:pt-0">
                        ...
                        <button
                          ...
                          className="inline-flex h-9 items-center gap-1 rounded-full border border-rose-500/70 px-3 text-[10px] uppercase tracking-[0.16em] text-rose-100 hover:bg-rose-500/10 transition"
                        >
      ...
      {/* EDIT MODAL */}
      {editingEvent && (
        <div className="fixed inset-0 z-40 bg-slate-950/70 p-0 sm:p-3">
          <div className="mx-auto flex h-full w-full items-stretch sm:items-center sm:justify-center">
            <div className="w-full sm:max-w-3xl h-full sm:h-auto rounded-none sm:rounded-2xl border border-white/15 bg-slate-950/95 p-4 sm:p-6 shadow-[0_0_40px_rgba(56,189,248,0.35)] overflow-hidden">
              {/* header */}
              <div className="mb-3 flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="rounded-full bg-slate-900/80 p-2 text-slate-400 hover:text-slate-100 hover:bg-slate-800 transition"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>

              {/* ✅ scroll area (mobile full height) */}
              <div className="mt-3 max-h-[calc(100dvh-120px)] sm:max-h-[70vh] overflow-auto pr-1">
                <div className="grid gap-4 md:grid-cols-[1fr_1fr]">
                  ...
                  <div className="space-y-3 md:pr-1">
                    <div className="grid gap-3 sm:grid-cols-1 md:grid-cols-[1.5fr_1fr]">
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-white/10 bg-slate-950/90 px-3 py-2 text-[11px] text-slate-100 outline-none ring-0 focus:border-cyan-400/80 disabled:opacity-50"
                        />
                      </div>
                      <div className="space-y-1">
                        <label className="text-[10px] font-medium uppercase tracking-[0.16em] text-slate-300">
                    ...
                    <div className="rounded-xl border border-cyan-500/30 bg-slate-950/90 px-3 py-2">
                      <label className="inline-flex items-center gap-2 text-[11px] text-slate-100">
                        ...
                        />
                        <span>
                          Usa come evento in evidenza (banner homepage).
                        </span>
                      </label>
                      <p className="mt-1 text-[10px] text-slate-400">
                        Solo eventi{" "}
                        <span className="font-semibold">in atto</span> possono
                        essere featured.
                      </p>
                    </div>
                    ...
                    <div className="flex justify-end gap-2 pt-1">
                      {!isPastEditing && (
                        <button
                          ...
                          disabled={editSaving}
                          className="inline-flex items-center justify-center gap-2 rounded-full bg-linear-to-r from-cyan-400 to-fuchsia-500 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-black shadow-[0_0_20px_rgba(56,189,248,0.8)] hover:brightness-110 transition disabled:opacity-60"
                        >
                          {editSaving ? (
                            <>
                              <Loader2 className="h-3.5 w-3.5 animate-spin" />
                  ...
                  <div className="space-y-3 md:pr-3">
                    <div className="rounded-2xl border border-white/10 bg-slate-950/70 p-3">
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setEditSendMessageEmail(e.target.value)
                          }
                      ...
                      <div className="mt-1 space-y-2">
                        ...
                        <div className="flex flex-col gap-2 rounded-2xl border border-dashed border-white/15 bg-slate-950/80 p-3">
                          ...
                          <div className="flex flex-col gap-1 text-[11px] text-slate-500 sm:flex-row sm:items-center sm:justify-between">
                            <span>
                              Se vuoto, usa banner_image_url dell’evento.
                            </span>
                    ...
                    <button
                      ...
                      className="w-full inline-flex h-10 items-center justify-center gap-2 rounded-full border border-slate-600/70 px-3 text-[11px] uppercase tracking-[0.18em] text-slate-200 hover:border-cyan-400/70 hover:text-cyan-100 transition"
                    >
      ...
      {logsModalOpen && logsEvent && (
        <div className="fixed inset-0 z-50 bg-black/60 p-0 sm:p-3">
          <div className="mx-auto flex h-full w-full items-stretch sm:items-center sm:justify-center">
            <div className="w-full sm:max-w-3xl h-full sm:h-auto rounded-none sm:rounded-2xl border border-white/10 bg-slate-950/95 p-3 sm:p-4 shadow-2xl overflow-hidden">
              <div className="mb-3 flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-600/70 text-slate-300 hover:bg-slate-800"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
              ...
              <div className="mb-3 flex flex-wrap items-center gap-2">
                <button
                  ...
                  className={`rounded-full px-3 py-2 text-[10px] uppercase tracking-[0.16em] border ${
                    logsChannel === "all"
              ...
              <div className="mt-2 max-h-[calc(100dvh-190px)] sm:max-h-[420px] overflow-auto rounded-xl border border-white/5 bg-slate-950/80">
                {sendLogsLoading ? (
              ...
              <div className="mt-3 flex justify-end">
                <button
                  type="button"
                  onClick={closeSendLogsModal}
                  className="inline-flex h-9 items-center rounded-full border border-slate-600/70 px-4 text-[11px] text-slate-100 hover:bg-slate-800"
                >
                  Chiudi
                </button>
              </div>
