    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="mb-1 rounded-2xl border border-white/5 bg-slate-950/60 p-3 sm:p-4">
        <div className="flex flex-col gap-4">
          <div className="rounded-2xl border border-white/5 bg-slate-900/30 p-4 sm:p-5">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="h-8 rounded-full border border-slate-700 bg-slate-900/70 px-3 text-[10px] uppercase tracking-[0.16em] text-slate-200 transition hover:border-slate-500 hover:bg-slate-900"
                title="Reset filtri anagrafica"
              >
                Reset
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
              ...
              <div className="lg:col-span-4">
                ...
                <p className="mt-2 text-[11px] leading-snug text-slate-500">
                  Filtra per giorno su{" "}
                  <span className="text-slate-300">validità</span> o{" "}
                  <span className="text-slate-300">creazione</span>.
                </p>
              </div>
              ...
              <div className="lg:col-span-8">
                ...
                <div className="mt-2 rounded-xl border border-white/5 bg-slate-950/40 px-3 py-2 text-[11px] text-slate-500">
                  Tip: puoi usare{" "}
                  <span className="text-slate-300">solo la data</span> (dalle
                  00:00) oppure{" "}
                  <span className="text-slate-300">solo l’ora</span> (da oggi a
                  quell’ora).
                </div>
              </div>
            </div>
